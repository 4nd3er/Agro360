...
const Survey = ({ title, imageSrc, isActive, id }) => {
  ...
  return (
    ...
    <div
      ...
      onClick={handleClick}
    >
      <div className="activoinactivo flex place-items-center absolute top-[-5px] rounded-full px-2">{isActive ? "Activo" : "Inactivo"}</div> {/* Muestra 'Activo' o 'Inactivo' dependiendo del valor de 'isActive' */}
