...
function FormAlert({ errors, success }) {
    return (
        <>
            {errors && errors.length > 0 ? errors.map((error, i) => (
                ...
                <div className="bg-green-500 p-4 text-white my-5 rounded-md flex items-center">                    
                    <svg xmlns="http://www.w3.org/2000/svg" class="bi bi-check-lg w-6 h-6 me-4" fill="none" viewBox="0 0 20 20" strokeWidth={1.5} stroke="currentColor">
