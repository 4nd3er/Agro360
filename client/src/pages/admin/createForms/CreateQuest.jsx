		...
		<aside>
			...
			<form onSubmit={handleSubmit}>
							...
							>
								<div className='flex flex-col md:flex-row lg:flex-row xl:flex-row lg:justify-between px-1 lg:px-10 gap-3'>
									<input
										...
										className='border-b-2 p-2 border-gray-400 w-full md:w-3/5 lg:w-3/6 transition-all'
										value={question[0][1]}
								...
								<div className='px-1 lg:px-10 mb-5 text-red-500 flex flex-col md:flex-row lg:flex-row xl:flex-row md:justify-around lg:justify-around xl:justify-around select-none'>
									<span className={`${question[0][1] === '' && validationQuestionContent < question.length ? 'opacity-100' : 'opacity-0'} transition-[.1s_all]`}>Debes digitar una pregunta</span>
				...
				<section>
					<button
						type='submit'
						className='fixed bottom-8 right-2 lg:right-6 bg-[#39A900] px-3 py-2 text-white rounded-lg'
					>
						Guardar
					</button>
				</section>
			</form>
			<section className='fixed right-2 lg:right-28 bottom-20 bg-white p-2 rounded-xl border-2 shadow-xl'>
