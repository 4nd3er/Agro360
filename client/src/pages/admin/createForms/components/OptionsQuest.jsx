const OptionsQuest = ({ option, index, questionIndex, question, handleOptionChange, deleteOption, questionTypeValue, validationQuestionOption, params }) => {
    let questionType = '';
    let questionOptions = '';
    if (!params.id) {
        ...
        <>
            ...
            {questionTypeValue[questionType] == 'Escala de Likert' && (
                <div className='py-0 md:py-4 lg:py-4'>
                    ...
                    <ul className="flex justify-between md:justify-center lg:justify-center gap-0 md:gap-14 lg:gap-16">
