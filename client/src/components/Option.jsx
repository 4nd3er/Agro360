                ...
                <div className='py-4 overflow-auto max-w-max'>
                    <ul className="flex gap-16 mb-4">
                        ...
                        <li className="flex flex-col text-center" onClick={() => handleChange('2')}>
                            ...
                            <label
                                htmlFor="opcion2"
                                className={`${compValue() == '2' ? '!bg-gray-400' : ''} px-5 py-4 text-gray-800 transition-all bg-white border-2 border-gray-500 rounded-lg cursor-pointer peer-checked:bg-gray-300  ${value != '2' ? 'hover:bg-gray-100 hover:text-gray-600' : ''} text-3xl select-none`}
                            >
                                2
                            </label>
                            <label className="text-xs mt-1">
                        ...
                        <li className="flex flex-col text-center" onClick={() => handleChange('3')}>
                            ...
                            <label
                                htmlFor="opcion3"
                                className={`${compValue() == '3' ? '!bg-gray-400' : ''} px-5 py-4 text-gray-800 transition-all bg-white border-2 border-gray-500 rounded-lg cursor-pointer peer-checked:bg-gray-300  ${value != '3' ? 'hover:bg-gray-100 hover:text-gray-600' : ''} text-3xl select-none`}
                            >
                                3
                            </label>
                            <label className="text-xs mt-1">
                        ...
                        <li className="flex flex-col text-center" onClick={() => handleChange('4')}>
                            ...
                            <label
                                htmlFor="opcion4"
                                className={`${compValue() == '4' ? '!bg-gray-400' : ''} px-5 py-4 text-gray-800 transition-all bg-white border-2 border-gray-500 rounded-lg cursor-pointer peer-checked:bg-gray-300  ${value != '4' ? 'hover:bg-gray-100 hover:text-gray-600' : ''} text-3xl select-none`}
                            >
                                4
                            </label>
                            <label className="text-xs mt-1">
                        ...
                        <li className="flex flex-col text-center" onClick={() => handleChange('5')}>
                            ...
                            <label
                                htmlFor="opcion5"
                                className={`${compValue() == '5' ? '!bg-gray-400' : ''} px-5 py-4 text-gray-800 transition-all bg-white border-2 border-gray-500 rounded-lg cursor-pointer peer-checked:bg-gray-300  ${value != '5' ? 'hover:bg-gray-100 hover:text-gray-600' : ''} text-3xl select-none`}
                            >
                                5
                            </label>
                            <label className="text-xs mt-1">
